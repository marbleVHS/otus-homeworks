...
import ru.otus.crm.service.CacheDbServiceClient;

public class CacheDbServiceDemo {
    private static final String URL = "jdbc:postgresql://localhost:5430/demoDB";
    private static final String USER = "usr";
    private static final String PASSWORD = "pwd";

    private static final Logger log = LoggerFactory.getLogger(CacheDbServiceDemo.class);
